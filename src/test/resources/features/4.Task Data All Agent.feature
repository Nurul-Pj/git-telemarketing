Feature: Task New Agent
  ...
  Scenario: Input field search (Data All)  
   	When User input search in data all
 ...
 #Scenario: Next page (Data All)
  ...
  Scenario: Filter search (Data All)  
  ...
  Scenario: Input status acitivity invalid (Data All)  
    ...
    And User click close
 	...
 	Scenario: Dropdown Tersambung, Diangkat, Setuju	(Data All)  
    And Input activity data form with "Tersambung" as status and "Diangkat" as statuscall 
    ...
    And User click konfirmasi YES
 	...
 	Scenario: Dropdown Tersambung, Diangkat, Follow Up (Data All)     
    When User click data in follow up
    And Input activity data form with "Tersambung" as status and "Diangkat" as statuscall 
  ...
  Scenario: Dropdown Tersambung, Diangkat, Tolak (Data All)    
    When User click data in follow up
    And Input activity data form with "Tersambung" as status and "Diangkat" as statuscall 
  ...
  Scenario: Dropdown Tersambung, Diangkat, Berhasil (Data All)     
    When User click data in follow up
    And Input activity data form with "Tersambung" as status and "Diangkat" as statuscall 
  ...
  Scenario: Dropdown Tersambung, Diangkat, Tidak Berhasil (Data All)     
    When User click data in follow up
    And Input activity data form with "Tersambung" as status and "Diangkat" as statuscall 
  ...
  Scenario: Dropdown Tersambung, Salah Sambung (Data All)     
    When User click data in follow up
  ...
  Scenario: Dropdown Tersambung, Tidak Diangkat (Data All)     
    When User click data in follow up
  ...
  Scenario: Dropdown Tidak Tersambung, Nomer Salah (Data All)  
    When User click data in follow up
  ...
  Scenario: Dropdown Tidak Tersambung, Mailbox (Data All)  
    When User click data in follow up
  ...
  Scenario: Dropdown Tidak Tersambung, Invalid Number (Data All)  
    When User click data in follow up
  ...
  Scenario: Dropdown Tidak Tersambung, Telepon Not Register (Data All)  
    When User click data in follow up
  ...
  Scenario: Input field request phone (Data All)  
  	When User click data in follow up
